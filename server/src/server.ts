...
async function validateTextDocument(textDocument: TextDocument): Promise<void> {
  ...
  runner.on('processClose', (...args: any[]) => {
    console.log('processClose', ...args);
  });

  runner.on('processExit', (...args: any[]) => {
    console.log('processExit', ...args);
  });
  ...
  runner.on('executableStdErr', (...args: any[]) => {
    const [a, b] = args;
    console.log('executableStdErr', (a as Buffer).toString(), b);
  });

  runner.on('executableOutput', (...args: any[]) => {
    console.log('executableOutput', ...args);
    console.log('closing process');
    runner.closeProcess();
  });

  runner.on('terminalError', (...args: any[]) => {
    console.log('terminalError', ...args);
    console.log('closing process');
    runner.closeProcess();
  });
